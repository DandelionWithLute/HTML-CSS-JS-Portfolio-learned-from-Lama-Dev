...
window.addEventListener("scroll", ()=>{
    ...
    // saluteTextContainer.style.transform = `translateY(100px)`
    saluteTextContainer.style.transform = `translateY(${offsetY * 0.1}px)`//It's moving, but at another speed.
    saluteImgContainer.style.transform = `translate(${offsetY * 0.4}px, ${offsetY * 0.7}px)`//It's moving, but at another speed.
